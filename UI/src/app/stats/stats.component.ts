...
export class StatsComponent implements OnInit {
  ...
  public stepsChartData: ChartConfiguration<'line'>['data'] = {
    ...
    datasets: [
      {
        data: [8500, 9200, 7800, 10000, 8900, 7500, 9500],
        label: 'Steps',
        fill: true,
        tension: 0.4,
        borderColor: '#43d167',
  ...
  public caloriesChartData: ChartConfiguration<'bar'>['data'] = {
    ...
    datasets: [
      {
        data: [1800, 2100, 1900, 2200, 2000, 1700, 2300],
        label: 'Calories',
  ...
  ngOnInit(): void {
    // Here you would typically fetch real data from your service
  }
} 